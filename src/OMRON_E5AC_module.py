...
#OMRON E5AC, serial comunication, CompoWay/F(miniFINS) protocol
...
class Application:
    ...
    def Command_Response(self, cmd):
        ...
        time.sleep(0.1)                                        # Wait a minute (0.06s).    tried minimum wait time  ... about 0.05s
...
if __name__ == '__main__':
    ...
    #         str_ID            = self.OMRON_E5AC.Device_Info() 